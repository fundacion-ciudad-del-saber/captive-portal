...
const Survey = () => {
  return (
      ...
      <section className='w-full h-64 sm:h-52 bg-square-card bg-cover rounded-lg  shadow-lg overflow-hidden relative  my-12'>
            <a href='https://qs28.qservus.com/JdLzIb/'>
              <div className="h-full flex flex-col justify-between bg-gradient-to-r from-plaza to-transparent py-4 px-2">
                ...
                <div className="flex gap-x-2">
                    <a href='https://qs28.qservus.com/JdLzIb/' className="py-1 flex px-2 items-center gap-2 sm:text-md text-sm bg-white rounded-md hover:bg-gray-200 text-gray-900 font-semibold">
                        Llenar encuesta
